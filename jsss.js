...
function validateForm(){
  ...
  var iff=document.myform.iff.value;
  if(nam=="" || nam==null){
  ...
  else if(iff=="" || iff==null){
    document.getElementById("iff").innerHTML=" please enter event info";
    return false;
  }
  else if(iff.length<3){
     document.getElementById("iff").innerHTML="entr valid info";
    return false;
  }
  else if(iff.length>30){
     document.getElementById("iff").innerHTML="enter valid info";
    return false;
  }
  else if(isNaN(iff)==false){
    document.getElementById("iff").innerHTML="info should not be Numeric";
    return false;
  }
...
entry.addEventListener("click", displayDetails);
  ...
  var ifff = document.getElementById("ii").value;

  if(!name || !email || !mno || !ifff){
